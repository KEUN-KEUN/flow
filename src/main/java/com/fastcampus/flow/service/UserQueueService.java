...
public class UserQueueService {
    ...
    private final String USER_QUEUE_WAIT_KEY_FOR_SCAN = "users:queue:*:wait"; // 대기열 검색
    ...
    // 진입을 허용
    public Mono<Long> allowUser(final String queue, final Long count){ // count : 몇개의 인자를 허용할지
        // 진입을 허용하는 단계
